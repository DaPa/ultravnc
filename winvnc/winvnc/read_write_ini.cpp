...
LanOnly=myIniFile_In.ReadInt("admin", "LanOnly", 1);
LanMin=myIniFile_In.ReadInt("admin", "LanMin", 2);
LanMax=myIniFile_In.ReadInt("admin", "LanMax", 19);
...
myIniFile_Out.WriteInt("admin", "LanOnly", LanOnly);
myIniFile_Out.WriteInt("admin", "LanMin", LanMin);
myIniFile_Out.WriteInt("admin", "LanMax", LanMax);
